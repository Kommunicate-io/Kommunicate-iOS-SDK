...
@objc open class KMConversationBuilder : NSObject {
    ...
    @discardableResult
    public func withClientConversationId(_ clientConversationId:String?) ->  KMConversationBuilder {
    ...
    @discardableResult
    public func withAgentIds(_ agentIds: [String]) ->  KMConversationBuilder {
    ...
    @discardableResult
    public func withBotIds(_ botIds: [String]?) ->  KMConversationBuilder {
    ...
    @discardableResult
    public func skipRouting(_ skipRouting: Bool) ->  KMConversationBuilder {
    ...
    ///     @discardableResult
    public func useLastConversation(_ useLastConversation: Bool) ->  KMConversationBuilder {
    ...
    @discardableResult
    public func withConversationTitle(_ conversationTitle: String) ->  KMConversationBuilder {
    ...
    @discardableResult
    public func withMetaData(_ conversationMetadata: [AnyHashable : Any]) ->  KMConversationBuilder {
    ...
    @discardableResult
    public func useOriginalTitle(_ isUseOriginalTitle: Bool) ->  KMConversationBuilder {
    ...
    public  func build() ->  KMConversation {
        return conversation
    }

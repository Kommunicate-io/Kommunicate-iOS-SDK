...
extension KMStarRattingViewController: Localizable {
    enum LocalizedText {
        ...
        static let commentTitle = localizedString(forKey: "ConversationCommentTitle", fileName: filename)
        static let commentSectionTitle = commentTitle == "ConversationCommentTitle" ? "Add feedback (optional)" : commentTitle
    }
}
